...
const ADVANTAGES = [
  ...
  { icon: 'CalendarCheck', title: 'Запись онлайн за 2 минуты', desc: 'Выберите дату и время на сайте без звонков и ожидания.' },
];
...
const REVIEWS = [
  {
    name: 'Маргарита',
    location: 'Звенигород',
    text: 'Пятно было старое и очень большое. После чистки матрас стал заметно свежее и чище, запах тоже исчез. Результатом довольна.',
    rating: 5,
  ...
  },
  {
    name: 'Алексей',
    location: 'Голицыно',
    text: 'Работаю за компьютером каждый день, кресло за несколько лет сильно загрязнилось. После химчистки ткань стала гораздо светлее, ушли пятна от кофе и пыль. Всё сделали быстро и аккуратно.',
    rating: 5,
  ...
  },
  {
    name: 'Ольга',
    location: 'Балашиха',
    text: 'Заказывали чистку дивана. Были пятна и неприятный запах. После работы диван выглядит намного лучше, запаха больше нет. Спасибо за качественную работу.',
    rating: 5,
