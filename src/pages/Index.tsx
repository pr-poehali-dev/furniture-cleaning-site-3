        ...
        <div className="container relative px-4 md:px-8">
          ...
          <Reveal delay={160}>
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-xl">
              Рассчитайте точную стоимость, выберите удобную дату и время, оформите заявку онлайн за 2 минуты. Цена фиксируется сразу и не меняется после оформления заказа
            </p>
          </Reveal>
          <Reveal delay={240}>
